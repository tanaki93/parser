...
def get_data(context):
    ...
    try:
        ...
        # print(soup.find('main').find('div', class_='product parbase').find('div',
        #                                                                    class_='module product-description sticky-wrapper')
        #       .find('div', class_='sub-content product-detail-info inner sticky-on-scroll semi-sticky').find('div',
        #                                                                                                      class_='inner')
        #       .find('div', class_='product-item-buttons').find('div', class_='product-button-wrapper'))
...
def main():
    ...
    context = {
        'id': 57011,
        'url': 'https://www2.hm.com/tr_tr/productpage.0662369003.html'
    }
