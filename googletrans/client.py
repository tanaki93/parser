...
from googletrans.constants import DEFAULT_USER_AGENT, LANGCODES, LANGUAGES, SPECIAL_CASES, PROXIES, USERAGENTS
...
class Translator(object):
    ...
    def __init__(self, service_urls=None, user_agent=random.choice(USERAGENTS),
